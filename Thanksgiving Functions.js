...
function grandparents() {
	...
	document.getElementById("btwoclick").href = "javascript:aunt()";
}
...
function kardashian() {
	document.getElementById("imgc").src = "Kim K butt reaction.jpg";
...
function cards() {
	document.getElementById("imgc").src = "image.jpg";
...
function continue_relationship() {
	document.getElementById("imgc").src = "image.jpg";
	document.getElementById("txtc").href = "Will they continue to ask if you have a relationship regardless?";
...
function twitter() {
	...
	document.getElementById("bonec").innerHTML = "Start Again";
	document.getElementById("btwoc").style.display = "none";
...
function michael_cera() {
	document.getElementById("imgc").src = "image.jpg";
	document.getElementById("txtc").href = "You're gonna have the Michael Cera of Thanksgivings. Awkward, strange, and uncomfortable...just like the actor himself.";
...
function has_it() {
	...
	document.getElementById("btwoc").innerHTML = "Not really, but my stance on Taylor Swift has changed. I didn't want to like her new album, but how can you resist? Shake it off!";
...
function tensions() {
	document.getElementById("imgc").src = "image.jpg";
	document.getElementById("txtc").href = "Tensions may run high. Keep your cool and you'll have a great Turkey Day!";
...
function laid_back() {
	...
	document.getElementById("txtc").href = "Way to be laid back and chill on a day when all of your family will be in the same location with a limited amount of food! Go you!";
...
function buckle_up() {
	...
	document.getElementById("txtc").href = "Buckle up. It's gonna be awkward. I hope you're prepared for a lecture on family values, the dangers of partying, and how different the world was 'back in my day.'";
...
function TS_DM_x() {
	document.getElementById("imgc").src = "Actor.jpg";
	document.getElementById("txtc").href = "You might be able to make it out alive, void of smudgy cheek kisses from your Me-Maw. Be prepared to discuss her favorite actor, whose name she can't remember.";
